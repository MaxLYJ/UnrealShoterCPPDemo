 ...
 */
UCLASS(abstract)
class FIRSTPERSONCITY_API AShooterNPC : public AFirstPersonCityCharacter, public IShooterWeaponHolder
{
	GENERATED_BODY()
...
public:
	...
	/** Test function to demonstrate different damage types */
	UFUNCTION(BlueprintCallable, Category = "Damage Testing")
